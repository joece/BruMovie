var city = [
    { "title": "热门城市" ,
      "citys": ["北京", "上海", "广州", "深圳","成都", "重庆", "天津",
        "杭州", "南京","苏州","武汉","西安"]
    },
    {
      "title": "A",
      "citys": ["阿坝","阿拉善","阿里","安庆","鞍山","安顺","安阳","澳门"]
    },
    {
      "title": "B",
      "citys": ["北京","白银","保定","宝鸡","保山","包头", "巴中","北海", "蚌埠",
        "本溪", "毕节", "滨州","百色", "亳州" ],
    },
    {
      "title": "C",
      "citys": ["重庆","成都","长沙", "长春","沧州", "常德","昌都","长治","常州",
    ...
    {
      "title": "G",
      "citys": ["广州","赣州","桂林", "贵阳","甘南","甘孜", "广安", "广元","果洛","贵港"]
    },
    {
      "title": "H",
      "citys": [ "杭州","哈尔滨","合肥","海口","海东", "海北","海南","海西","邯郸","汉中", "鹤壁", "河池", "鹤岗", "黑河","衡水","衡阳","河源", "贺州", "红河","淮安","淮北", "怀化","淮南","黄冈","黄南","黄山","黄石", "惠州","葫芦岛","呼伦贝尔","湖州","菏泽"]
    },
    {
      "title": "J",
    ...
    {
      "title": "N",
      "citys": [ "南京","南昌",  "南宁", "南充", "南平",  "南通",  "南阳", "那曲", "内江", "宁德", "怒江"]
    },
    {
      "title": "P",
    ...
    {
      "title": "T",
      "citys": [ "天津", "太原", "泰安", "泰州", "唐山", "天水", "铁岭", "铜川", "通化",  "通辽", "铜陵", "铜仁", "台湾"]
    },
    {
      "title": "W",
    ...
    {
      "title": "Z",
      "citys": [ "杂多县", "赞皇县", "枣强县", "枣阳市",  "枣庄", "泽库县",  "增城市", "曾都区",  "泽普县", "泽州县", "札达县",  "扎赉特旗", "扎兰屯市", "扎鲁特旗", "扎囊县", "张北县", "张店区", "章贡区",  "张家港", "张家界",  "张家口", "漳平市",  "漳浦县",  "章丘市", "樟树市", "张湾区", "彰武县", "漳县", "张掖", "漳州", "长子县", "湛河区", "湛江", "站前区", "沾益县",  "诏安县",  "召陵区", "昭平县",  "肇庆", "昭通", "赵县"]
    }
  ]
